...
export const AddVideoCtrl = () => {
    ...
    return (
        ...
        <div className="w-full  bg-violet-950 fixed shadow-2xl z-20">
            ...
            <input type="text" value={video} onChange={(e) => setVideo(e.target.value)} className="block w-full p-4 pl-10 text-xl bg-transparent text-white focus:ring-purple-500 focus:border-purple-500" placeholder="Add New video" required />
            <button onClick={() => addVideo()} className="text-white absolute right-4 md:right-20 bottom-2.5 px-4 py-2 bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg">Add Video</button>
        </div>
