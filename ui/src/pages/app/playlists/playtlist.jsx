...
<div  className={`${!show&&"hidden"} z-10 absolute bottom-20 w-60 right-4 bg-white rounded-lg dark:bg-violet-950 shadow`}>
  <ul className="max-h-60 py-2 overflow-y-auto hide-scrollbar text-gray-700 dark:text-violet-200" aria-labelledby="dropdownUsersButton">
  ...
  <Link to="playlists" className="flex justify-center p-3 text-sm font-medium text-white border-t border-gray-200 rounded-b-lg bg-gray-50 dark:border-violet-600 hover:bg-gray-100 dark:bg-violet-700 dark:hover:bg-violet-600">
   Mange playlists
  </Link>
</div>
  </div>
