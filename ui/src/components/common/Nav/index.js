...
console.log(props)
    return (
        <Header style={{"display":"block ruby", background: "#1f1f1f", "zIndex": "1000", "left":0, "right":0, "top":0, "padding":"0px 20px 0px 20px"}}>
           {props.video !== undefined && props.video.title !== "" ? <h1 style={{"color":"white"}}> Current Playing: { props.video.title} </h1> : null}
